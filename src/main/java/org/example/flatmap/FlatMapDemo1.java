...
public class FlatMapDemo1 {
    public static void main(String[] args) {
        ...
        List<Integer> list1Multiply = list1.stream()
                .map(n -> n + 10)
                .collect(Collectors.toList());
        System.out.println(list1Multiply);
        ...
        List<Integer> finalListResult = finalList.stream()
                .flatMap(x -> x.stream().map(n -> n + 10))
                .collect(Collectors.toList());
        System.out.println(finalListResult);
    }
}
